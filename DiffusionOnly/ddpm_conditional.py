...
from utils import *
import copy
from modules2 import UNet, UNet_conditional, EMA
import logging
import numpy as np
...
class Diffusion:
    ...
    def noise_images(self, x, t):
        ...
        epslilon = torch.rand_like(x)
        return sqrt_alpha_hat * x + sqrt_one_minus_alpha_hat * epslilon, epslilon
...
def launch():
    ...
    args.image_size = 64
    args.num_classes = 10
    args.dataset_path = r"D:\AI\stable_diffusion\DiffusionOnly\archive\cifar10-64\train"
    args.device = "cuda"
    args.lr = 3e-4
    train(args)
