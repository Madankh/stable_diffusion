...
class DiffusionModel(nn.Module):
    ...
    def get_loss(self, batch, batch_idx):
        """
        Corresponds to Algorithm 1 from 
        """
        ...
        # Run the noisy images through the U-Net to get predicted Noise
    ...
    def denoise_sample(self, x, t):
        """Corresponds to the inner loop of the algo 2 from 
        (Ho et al., 2020)."""
        with torch.no_grad():
            if t>1:
            ...
            # Preform the denosing step to take the image from t to t-1
